...
function GuestOptionList({ options ,handleOptions }) {
  return (
    <div className="guestOptions">
      <OptionItem handleOptions="adult" options={options} minLimited={1} />
      <OptionItem handleOptions="children" options={options} minLimited={1} />
      <OptionItem handleOptions="room" options={options} minLimited={1} />
    </div>
  );
}
